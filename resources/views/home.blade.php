...
<div id="main_content">
    ...
    <div id="left-sidebar" class="sidebar ">
        <h5 class="brand-name">SPPD<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                <li class="g_heading">Directories</li>
                <li @yield('class_menu')><a href="home"><i class="icon-home"></i><span>Dashboard</span></a></li>                        
                <li><a href="data_pegawai"><i class="icon-user"></i><span>Data Pegawai</span></a></li>
                ...
                <div class="page-header">
                    ...
                    <div class="right">
                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                <a class="nav-link icon d-none d-md-flex btn btn-default btn-icon ml-1" data-toggle="dropdown">{{ Auth::user()->name }} &nbsp;<i class="fa fa-user"></i></a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            Copyright © 2023 <a href="javascript:void(0)">Endrico Solution</a>.
                        </div>
